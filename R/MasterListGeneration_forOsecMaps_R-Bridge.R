...
# STEP 1.5:-----
## Parameter for ArcGIS Pro:----

  workSpace = in_params[[1]] # Choose a directory where a new master list will be saved
  oldTable = in_params[[2]] # Choose a previous master list "Table View"
  result = out_params[[1]] # Parameter "Table"

  
  wd=setwd(workSpace)
  x = read.xlsx(oldTable) # Previous Master List Table
...
# Export the output table to default file geodatabase
arc.write(result, xy_nvs_expro, overwrite=TRUE)
